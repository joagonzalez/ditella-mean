...
# Usamos para verificar el valor que predice el modelo an base al cual toma la desición
...
# Hallamos los valores de la matriz de confusión
...
#Grafiquen los errores de pronï¿½stico:
